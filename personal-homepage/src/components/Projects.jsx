...
const Projects = () => {
  return (
    <>
      ...
      <Text>
        This section contains a few of my personal projects that I would like to
        share, along with the GitHub links to the source code.
      </Text>
        ...
        <Card textAlign="center" alignItems="center" bg="orange.200">
          ...
          <CardBody>
            <Text textAlign="left">
              ...
              step-time, and watch as the disease spreads throughout until all
              are infected.
            </Text>
          </CardBody>
          <CardFooter>
